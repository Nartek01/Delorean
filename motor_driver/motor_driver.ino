...
void loop() {
  ...
  if (distance < 2000) {  // Motorn sluta aldrig att snurra
    // PWM HÖG
    ...
    /**
    @TODO Bilen ska backa när "distance" variabeln är under 400 värde i längre tid.
    Problemet är att den inte backa. Istället stannar den.
    **/    
    digitalWrite(in1, HIGH);
    digitalWrite(in2, HIGH);
  }
